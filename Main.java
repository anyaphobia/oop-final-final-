...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList<BorrowerHistory> borrowerHistory = new ArrayList<>();
        ArrayList<LiteraryHistory> literaryHistory = new ArrayList<>();
        BorrowingSystem system = new BorrowingSystem(lib.getMaterials(), manager, borrowerHistory, literaryHistory);
        ReturnSystem returnSystem = new ReturnSystem(lib.getMaterials(), manager, borrowerHistory, literaryHistory);
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    System.out.println("===== Borrower History =====");
                    if (borrowerHistory.isEmpty()) {
                        System.out.println("No records found.");
                    } else {
                        for (BorrowerHistory record : borrowerHistory) {
                ...
                case 6:
                    ...
                    if (literaryHistory.isEmpty()) {
                        System.out.println("No records found.");
                    } else {
                        for (LiteraryHistory record : literaryHistory) {
                        System.out.println(record);
                        }
                    }                   
                    break;
